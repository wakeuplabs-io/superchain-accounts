  ...
  async run() {
    ...
    const ui = new sst.aws.StaticSite(`${PROJECT_NAME}-ui`, {
      ...
      environment: {
        ...
        VITE_SCAN_BASE_SEPOLIA: process.env.SCAN_BASE_SEPOLIA!,
        VITE_SCAN_OPTIMISM_SEPOLIA: process.env.SCAN_OPTIMISM_SEPOLIA!,
        VITE_SCAN_UNICHAIN_SEPOLIA: process.env.SCAN_UNICHAIN_SEPOLIA!,
