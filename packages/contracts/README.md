...
```bash
npx hardhat add-claimable-badge --to 0x50A6a6D0C9f2C5e76699AD501db9a5Eff16fdd5D --id 2 --network optimism-sepolia
...
```bash
npx hardhat start-raffle --jackpot 100 --badges 1,2 --allocations 10,100 --reveal-date "2025-06-06T14:15:00.000-03:00" --network optimism-sepolia
