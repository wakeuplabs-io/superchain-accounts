...
const env = {
  ...
  SCAN_BASE_SEPOLIA: import.meta.env.VITE_SCAN_BASE_SEPOLIA,
  SCAN_OPTIMISM_SEPOLIA: import.meta.env.VITE_SCAN_OPTIMISM_SEPOLIA,
  SCAN_UNICHAIN_SEPOLIA: import.meta.env.VITE_SCAN_UNICHAIN_SEPOLIA,
...
const envSchema = z
  .object({
    ...
    SCAN_BASE_SEPOLIA: z.string().url(),
    SCAN_OPTIMISM_SEPOLIA: z.string().url(),
    SCAN_UNICHAIN_SEPOLIA: z.string().url(),
